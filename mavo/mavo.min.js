...
t.remove(this.editor))),!this.editor&&this.element.hasAttribute("data-edit")){this.editorType="linked";var s=t(this.element.getAttribute("data-edit"));s&&Mavo.is("formControl",s)&&(this.editor=s.cloneNode(!0),this.template||Mavo.observe(s,"all",function(t){var e=!0,i=!1,n=void 0;try{for(var a,r=o.copies[Symbol.iterator]();!(e=(a=r.next()).done);e=!0){var u=a.value;u.editor=s.cloneNode(!0),u.setValue(u.value,{force:!0,silent:!0})}}catch(h){i=!0,n=h}finally{try{!e&&r["return"]&&r["return"]()}finally{if(i)throw n}}}))}if(this.templateValue=this.getValue(),this["default"]=this.element.getAttribute("data-default"),this.computed||""===this["default"]?this["default"]=this.templateValue:null===this["default"]?this["default"]=this.editor?this.editorValue:this.emptyValue:Mavo.observe(this.element,"data-default",function(t){o["default"]=o.element.getAttribute("data-default")}),this.collection){var u=function(e){o.unobserve();var i=t.remove(t(".mv-item-controls",o.element)),n=e();return t.inside(i,o.element),
